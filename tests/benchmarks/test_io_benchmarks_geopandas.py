...
@pytest.mark.benchmark(group="read-pandas-lowres-admin0")
...
@pytest.mark.benchmark(group="write-pandas-lowres-admin0")
...
@pytest.mark.benchmark(group="write-pandas-modres-admin0")
...
### Write NHD
@pytest.mark.benchmark(group="write-pandas-nhd_hr")
