...
cdef extern from "ogr_api.h":
    ...
    OGRGeometryH       OGR_G_ForceTo(OGRGeometryH geometry, OGRwkbGeometryType eTargetType, char **papszOptions)
    OGRGeometryH       OGR_G_ForceToPolygon(OGRGeometryH geometry)
    OGRGeometryH       OGR_G_ForceToLineString(OGRGeometryH geometry)
